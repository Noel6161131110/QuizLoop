...
const handleIncrement = () => {
  ...
  try {
    // 1. Convert thumbnail base64 to Blob
  ...
  if (videoFile) {
    ...
    video.addEventListener("loadeddata", () => {
      ...
      if (ctx) {
        ...
        setShowPreviewSize(true); // Inform parent to resize modal
      }
  ...
  return (
    <div
        className={`relative w-full mx-auto px-2 ${
            showPreviewSize ? 'sm:max-w-[100%]' : 'sm:max-w-lg'
        } max-w-lg`}
    >
      {/* Close button */}
      <button
      ...
      {/* If file is selected and thumbnail available */}
      {videoFile && thumbnail ? (
        ...
        <div className="pt-4">
            ...
            <div className="text-sm text-[rgba(84,84,84,0.9)] sm:text-3xl mt-4 inline-flex items-center gap-x-2">
                ...
                <button
                    ...
                    className={`ml-6 mr-3 transition-colors ${
                    noOfMCQs === 0 ? "opacity-50 cursor-not-allowed" : "hover:text-red-500"
                    }`}
                ...
                <button
                    ...
                    noOfMCQs === 8 ? "opacity-50 cursor-not-allowed" : "hover:text-green-500"
                    }`}
